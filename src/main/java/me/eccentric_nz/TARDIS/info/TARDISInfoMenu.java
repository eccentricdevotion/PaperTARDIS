...
public enum TARDISInfoMenu {
    ...
    SONIC_STANDARD_RECIPE("TIS|Items|Sonic Screwdriver|Types|Standard Sonic|Recipe", "SONIC_STANDARD", "R"),
    ...
    SONIC_BIO_RECIPE("TIS|Items|Sonic Screwdriver|Types|Bio-scanner Sonic|Recipe", "SONIC_BIO", "R"),
    ...
    SONIC_REDSTONE_RECIPE("TIS|Items|Sonic Screwdriver|Types|Redstone Sonic|Recipe", "SONIC_REDSTONE", "R"),
    ...
    SONIC_DIAMOND_RECIPE("TIS|Items|Sonic Screwdriver|Types|Diamond Sonic|Recipe", "SONIC_DIAMOND", "R"),
    ...
    SONIC_EMERALD_RECIPE("TIS|Items|Sonic Screwdriver|Types|Emerald Sonic|Recipe", "SONIC_EMERALD", "R"),
    ...
    SONIC_ADMIN_RECIPE("TIS|Items|Sonic Screwdriver|Types|Admin Sonic|Recipe", "SONIC_ADMIN", "R"),
    ...
    SONIC_PAINTER_RECIPE("TIS|Items|Sonic Screwdriver|Types|Painter Sonic|Recipe", "SONIC_PAINTER", "R"),
    ...
    SONIC_BRUSH_RECIPE("TIS|Items|Sonic Screwdriver|Types|Brush Sonic|Recipe", "SONIC_BRUSH", "R"),
    ...
    SONIC_IGNITE_RECIPE("TIS|Items|Sonic Screwdriver|Types|Ignite Sonic|Recipe", "SONIC_IGNITE", "R"),
    ...
    SONIC_KNOCKBACK_RECIPE("TIS|Items|Sonic Screwdriver|Types|Knockback Sonic|Recipe", "SONIC_KNOCKBACK", "R"),
    ...
    ARS_CIRCUIT_RECIPE("TIS|Components|Architectural Reconfiguration System (ARS) Circuit|Recipe", "TARDIS_ARS_CIRCUIT", "R"),
    ...
    INVISIBILITY_CIRCUIT_INFO("TIS|Components|Invisibility Circuit|Info", "INVISIBLE_CIRCUIT", "I"),
    INVISIBILITY_CIRCUIT_RECIPE("TIS|Components|Invisibility Circuit|Recipe", "INVISIBLE_CIRCUIT", "R"),
    LOCATOR_CIRCUIT("TIS|Components|Locator Circuit", "COMPONENTS", "L"),
    LOCATOR_CIRCUIT_INFO("TIS|Components|Locator Circuit|Info", "TARDIS_LOCATOR_CIRCUIT", "I"),
    LOCATOR_CIRCUIT_RECIPE("TIS|Components|Locator Circuit|Recipe", "TARDIS_LOCATOR_CIRCUIT", "R"),
    ...
    public boolean isRoom() {
        switch (this) {
            case ALLAY, ANTIGRAVITY, APIARY, AQUARIUM, ARBORETUM, BAKER, BAMBOO, BEDROOM, BIRDCAGE, CHEMISTRY, EMPTY, EYE,
                    ...
                    LIBRARY, MANGROVE, MAZE, MUSHROOM, NETHER, OBSERVATORY, PASSAGE, PEN, POOL, RAIL, RENDERER, SHELL, SMELTER, STABLE,
