...
public class TARDISSQLiteDatabase {
    ...
    public void createTables() {
        ...
        try {
            ...
            String queryFlight = "CREATE TABLE IF NOT EXISTS " + prefix + "flight (f_id INTEGER PRIMARY KEY NOT NULL, uuid TEXT DEFAULT '', tardis_id INTEGER, location TEXT DEFAULT '', stand TEXT DEFAULT '', display TEXT DEFAULT '')";
            ...
            String queryPlots = "CREATE TABLE IF NOT EXISTS "+ prefix + "plots (plot_id INTEGER PRIMARY KEY NOT NULL, uuid TEXT DEFAULT '', world TEXT COLLATE NOCASE DEFAULT '', chunk_x INTEGER DEFAULT 0, chunk_z INTEGER DEFAULT 0, size INTEGER DEFAULT 3, name TEXT DEFAULT '')";
            statement.executeUpdate(queryPlots);
