...
|----------|---------|------|
| ![Static Badge](https://img.shields.io/badge/WIP-f90?style=flat-square) | **Update to 1.21.6**<br/>- Add new blocks to appropriate rooms e.g. firefly bush to Mangrove, dry grass to Iistabul?<br/>- Related to above - [#902](https://github.com/eccentricdevotion/TARDIS/issues/902) Room updates<br/>- Utilise new dialog screens - e.g. for TARDIS Information System | [#902](https://github.com/eccentricdevotion/TARDIS/issues/902)<br/>- Extract all NMS/CB use to interfaces for separate spigot / paper modules<br/>- Figure out how to use paperweight-userdev with Maven |
