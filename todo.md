...
|----------|---------|------|
| ![Static Badge](https://img.shields.io/badge/WIP-f90?style=flat-square) | **Update to 1.21.7**<br/>- Add new blocks to appropriate rooms e.g. firefly bush to Mangrove, dry grass to Iistabul?<br/>- Related to above - [#902](https://github.com/eccentricdevotion/TARDIS/issues/902) Room updates<br/>- Utilise new dialog screens<br/>- Add default text to all `plugin.getLanguage().getString()` calls<br/>- Find a better alternative to checking TextComponents for specific text i.e. not `TARDISStringUtils.stripColour()`<br/>- Add Blueprints to _kits.yml_ functionality | [#902](https://github.com/eccentricdevotion/TARDIS/issues/902) |
